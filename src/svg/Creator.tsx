...
const SvgCreator: React.SFC = props => (
  <svg
    className="Zi Zi--Creator"
    fill="currentColor"
    viewBox="0 0 24 24"
    width={16}
    height={16}
